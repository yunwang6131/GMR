...
ROBOT_XML_DICT = {
    ...
    "d2_smplify": ASSET_ROOT / "d2_smplify" / "D2_QIAOJIE_smplify.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "bvh_lafan1":{
        ...
        "d2_smplify": IK_CONFIG_ROOT / "bvh_lafan1_to_d2_smplify.json",
    },
    "bvh_nokov":{
    ...
    "bvh_xsens":{
        ...
        "d2_smplify": IK_CONFIG_ROOT / "bvh_xsens_to_d2_smplify.json",
    },
    "fbx":{
